...
<div class="col-md-10">
    ...
    <div class="card card-primary">
        ...
        <?php endif; ?>
        <form class="form-horizontal" method="post" action="<?= base_url('buku/update/' . $buku->kode_buku) ?>">
            <?= csrf_field(); ?>
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="jenis_buku" name="jenis_buku" value="<?= $buku->jenis_buku; ?>">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label for="no_rak" class="col-sm-2 col-form-label">No
                        Rak</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="no_rak" name="no_rak" value="<?= $buku->no_rak; ?>" />
                    </div>
                </div>
